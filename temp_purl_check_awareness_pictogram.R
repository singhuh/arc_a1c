...
ggplot(
  ...
  labs(
    title = "Prior A1c awareness among hyperglycemic donors before March 2025 screening",
    subtitle = "Hyperglycemia includes both prediabetes and diabetes; q3 asks whether donors already knew their own A1c",
    x = NULL,
    y = "Percentage of donors",
    caption = "The `a1c` value in this survey file is the March 2025 screening result, not a pre-screening A1c."
  ) +
  customeTheme +
  theme(
...
race_awareness_plot <- ggplot(
  survey_hyper_race_awareness_summary,
  aes(x = raceeth, y = lacking_awareness_pct)
) +
  geom_col(width = 0.7, fill = "#FDE79B", show.legend = FALSE) +
  geom_text(
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%"), limits = c(0, 100)) +
  labs(
    title = "Lack of prior A1c awareness among hyperglycemic donors by race/ethnicity",
    subtitle = paste("Lack of awareness defined as q3 response of No or Unsure; race p", race_p_text),
    x = NULL,
...
urban_awareness_plot <- ggplot(
  survey_hyper_urban_awareness_summary,
  aes(x = urban_rural_group, y = lacking_awareness_pct)
) +
  geom_col(width = 0.7, fill = "#FDB04A", show.legend = FALSE) +
  geom_text(
    aes(label = paste0(round(lacking_awareness_pct, 1), "%")),
    hjust = -0.2,
    size = 3.5
  ...
  scale_y_continuous(labels = function(x) paste0(x, "%"), limits = c(0, 100)) +
  labs(
    title = "Lack of prior A1c awareness among hyperglycemic donors by urbanicity",
    subtitle = paste("Lack of awareness defined as q3 response of No or Unsure; urbanicity p", urban_p_text),
    x = NULL,
    y = "Hyperglycemic donors lacking definite prior A1c awareness (%)"
  ) +
  customeTheme +
...
print(race_awareness_plot)
print(urban_awareness_plot)
